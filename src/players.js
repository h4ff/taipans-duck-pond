(() => {
  ...
  // v0.87 fake roster used only to prove persistent player identity.
  // Player appearance belongs here; duck type/date belongs to the event data.
  window.DUCK_POND_PLAYERS = Object.freeze([
    { id: "p001", name: "Alex Marsh", presentation: "male", featherTone: "white", build: "standard", roles: [] },
    { id: "p002", name: "Brooke Lane", presentation: "female", featherTone: "lightBrown", build: "standard", roles: [] },
    { id: "p003", name: "Chris Webb", presentation: "male", featherTone: "yellow", build: "stocky", roles: ["captain"] },
    ...
    { id: "p007", name: "Pat President", presentation: "male", featherTone: "white", build: "standard", roles: ["president"] },
